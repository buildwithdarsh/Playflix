...
const tabs: Tab[] = [
  ...
  },
  {
    ...
    match: (p) => p.startsWith('/library') || p.startsWith('/watchlist'),
  },
  {
    label: 'Profile',
    href: '/profile',
...
export default function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 z-50 w-full max-w-[476px] left-1/2 -translate-x-1/2 lg:hidden"
      style={{
          ...
          return (
            ...
            >
              <div className="flex flex-col items-center gap-0.5 min-w-[48px] min-h-[44px] justify-center relative">
                <span style={{ color: isActive ? ACCENT : '#71717A' }}>
                  {tab.icon(isActive)}
                </span>
                <span
